...
{
    public class SephirothWipeSceneSwitchingPostProcessor : UnityEditor.AssetPostprocessor
    {
        private const string BUILD_DIRECTORY_PATH = "SephirothSceneSwitchingEffects/CircleWipe/UseScene";
