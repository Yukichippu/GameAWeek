...
{
    public class SephirothGrayScaleFadeSceneSwitchingPostProcessor : UnityEditor.AssetPostprocessor
    {
        private const string BUILD_DIRECTORY_PATH = "SephirothSceneSwitchingEffects/GrayScale/UseScene";
